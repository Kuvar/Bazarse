...
namespace House.Customs
{
    public class CustomEntry : Entry, IControlValidation
    {
        #region Property
        ...
        public static readonly BindableProperty HasErrorProperty =
            BindableProperty.Create("HasError", typeof(bool), typeof(CustomEntry), false, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty ErrorMessageProperty =
           BindableProperty.Create("ErrorMessage", typeof(string), typeof(CustomEntry), string.Empty);
        ...
        public static readonly BindableProperty ShowErrorMessageProperty =
           BindableProperty.Create("ShowErrorMessage", typeof(bool), typeof(CustomEntry), false, propertyChanged: OnShowErrorMessageChanged, defaultBindingMode: BindingMode.TwoWay);
        ...
        private static void OnShowErrorMessageChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            CustomEntry control = bindable as CustomEntry;
